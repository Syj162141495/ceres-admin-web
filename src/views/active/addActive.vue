      ...
      <el-col :span="12">
        <el-form ref="form" :model="form" label-width="100px">
          ...
          <el-form-item label="优惠方式:">
            <el-radio-group v-model="form.discountMode" @change="selectDiscount">
          ...
          <el-form-item label="优惠方案:">
            <el-radio-group v-model="form.discountProgramme" @change="selectPreScheme">
              <el-radio :label="1" :disabled="form.discountMode === 2 || unStart">叠加优惠</el-radio>
      ...
      <el-col :span="12">
        <div class="photo">
          <el-upload
            ...
            :disabled="unStart"
          >
            <img v-if="form.image != ''" :src="form.image" class="avatar" width="80" height="80">
