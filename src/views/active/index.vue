      ...
      <div class="formSearch">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="营销方式">
            <el-select v-model="formInline.discountMode" placeholder="请选择营销方式">
          ...
          <el-form-item>
            ...
            <el-button type="primary" plain @click="addActive">新建活动</el-button>
          </el-form-item>
        </el-form>
      </div>
      <!-- 表格 -->
          ...
          <el-table-column label="操作" show-overflow-tooltip>
            <template slot-scope="scope">
              <div class="btnList">
                ...
                <el-button v-if="scope.row.state != 4" type="text" @click="edit(scope.row)">编辑</el-button>
                <el-button v-if="scope.row.state != 4" type="text" @click="del(scope.row)">结束</el-button>
                <el-button v-if="scope.row.state == 4" type="text" @click="deleteA(scope.row)">删除</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
